...
from models import custom_cnn, resnext, i3d, i3d_bert, ensemble
    ...
    if cfg.model.name == 'ccnn':
        ...
        if cfg.training.continue_training:
            ...
            if cfg.data.type == 'two-stream':
                ...
                model_flow = i3d_bert.flow_I3D64f_bert2_FRMB(cfg.model.pre_trained_checkpoint_flow, cfg.model.length,
                                                        cfg.model.n_classes, cfg.model.n_input_channels_flow,
                                                        cfg.model.pre_n_classes, cfg.model.pre_n_input_channels_flow)
                model = ensemble.FlexEnsemble(model_img, model_flow)
